@extends('formato')
    ...
    @section('Arr')
    <div class=""style=" ;border-radius: 10px; padding: 10px; background-color: white; margin: 2.5% ">
...
<p>Biografía
  ...
  Más tarde volvió a retomar sus estudios y en 2017, finalmente se graduó en Ciencias de la Computación, dando el discurso de cierre en la Universidad de Harvard.En 2007 la revista Forbes, publicó el ranking de las 25 personas más influyentes de Internet. Zuckerberg, como jefe ejecutivo del sitio, claramente hacia parte de la lista. Uno de sus mayores logros fue vender por 256 millones de euros el 1,6 por ciento del portal a Microsoft. En 2008 Zuckerberg hacia parte de los 1.125 hombres más ricos del mundo según Forbes. Y también uno de los adinerados más jóvenes. Sus oficinas en el 2008 ya ocupaban cuatro edificios y tenía unos 400 empleados; tanto Viacom como Yahoo!, estaban interesados en comprar acciones en Facebook.

Sus mayores ingresos provenían de su contrato con Microsoft sobre anuncios publicitarios. Una de sus grandes competencias en el inicio fue MySpace, propiedad de News Corp, el imperio de Rupert Murdoch. Pero rápidamente Facebook creció tres veces más rápido que su rival. Pero luego de estar en este punto de fama e importante, tres de sus compañeros que en un comienzo colaboraron en la creación de Facebook decidieron tomar acciones legales afirmando que Zuckerberg se había “apoderado de la idea”. El creador de Facebook tiene grandes inclinaciones filantrópicas. Se adhirió a la campaña The Giving Pledge, una iniciativa comandada por los multimillonarios Bill Gates y Warren Buffett que busca que los grandes magnates donen la mitad de sus fortunas para causas filantrópicas.

La revista Time lo mencionó como el personaje del año, y Hollywood aprovechaba la oportunidad para lanzar un biopic sobre un personaje de 26 años: La Red Social (2010). Basada en el libro de Ben Mezrich Multimillonarios por accidente bajo la dirección de David Fincher. En el año 2012 Mark Zuckerberg contrajo matrimonio con Priscilla Chan. En 2015 nació Max, primer hijo de la pareja. En la actualidad, aparece en la lista de multimillonarios de la revista Forbes, con una fortuna valorada en US $ 63 300 millones de dólares, ocupando el puesto número cinco entre los más ricos del mundo. Ya no se que escribir pero bueno necesito llenar espacio jajajaaj bueno voy bien con el proyecto este, bue ahre son las 10:50 es jueves y se entrega maniana jaajjaaj no tengo la letra enie. bueno voy a seggir poniendo cosas bobas. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam </p>
